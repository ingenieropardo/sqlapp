...
<center style="color: black; ">
    <h1 style="font-family: engravers;"><b> SQLApp 1.0</b></h1>
		<img src="img/logo-hubemar.png" alt="" class="logoresponsivo">
		<form action="index.php" method="post">
		    ...
		    <label class='olvide' onclick='resetear()'>Recordar contraseña</label>
		    <div class="form-item">
		        <input type="submit" class="btn btn-inverse" name="conecta" value="Entrar" >
		        <a href="/basf/" class="btn btn-primary"><span class="fa fa-window-restore"></span> &nbsp;Ingresar a BASF</a>
		    </div>
		</form>
