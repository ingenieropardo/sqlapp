	...
	<div class="row">
			...
			<table>
				...
				<tr>
					...
					<td><select id="cbxReporte1" style="width: 350px;">
						...
						<!-- Llenar el combo con los reporte de exportaciones  -->
						<?php echo listaparametros($_SESSION['ideusuario'], 'E'); ?>
  	...
  	<div class="col-md-6" style="width: 620px; ">
	  	<div class="seccion">
			...
			<h2 align="center">Exportaciones</h2>
	  	</div>
