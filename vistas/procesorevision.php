...
<div class="vistapc" style="margin-top: -30px; color: black; font-size: 14px;">
	...
	<div class="row">
	  <div class="col-md-4" style="width: 560px">
	  	<div class="seccion">
	  		<div class="panel">CONTROL REVISION DECLARACIONES DE IMPO & DAV </div>
			<table>
				<tr>
					<td width="110px">Tipo de Revision</td>			
					<td><select id="cbxRevision">
						<option value="P">Primera Revisión</option>
						<option value="S">Segunda Revisión</option>
						<option value="T">Tercera Revisión</option>
					</select></td>
				</tr>
				<tr>

					<td>Ejecutivo</td>			
					<td><input id="textEjecutivo1" type="text" value="<?php echo $nomEjecutivo; ?>" disabled>
					</td>
				</tr>
				<tr>
					<td>Analista</td>			
					<td><input id="textAnalista1" type="text" value="<?php echo $nomAnalista; ?>" disabled>
					</td>
				</tr>
				<tr>
					<td>Revisor</td>			
						<td><input id="textRevisor1" type="text" value="<?php echo $nomRevisor; ?>" disabled>
					</td>
				</tr>
			</table>
	  	</div> <br>
	  	<div class="seccion">
	  		<div class="panel">AREA DE COMENTARIOS</div>
			<table>
				<tr>
					<td width="200px">Observaciones</td>			
					<td><textarea style="width: 300px; height: 80px" id="txtObservaciones"></textarea></td>
				</tr>
				<tr>
					<td>Número Errores</td>			
					<td><input type="text" id="txtNro_errores" disabled></td>
				</tr>
			</table>
	  	</div>
	  </div>
	  ...
	  <div class="col-md-6" style="width: 620px; ">
	  	<div class="seccion">
			...
			<table>
				<tr>
					<td width="200px">
						<input type="radio" name="xmodalidad" id="mod_imp" checked> Importación <br>
						<input type="radio" name="xmodalidad" id="mod_exp"> Exportación						
					</td>	
					<td width="200px">
						<input type="radio" name="xmodalidad" id="mod_dta"> Dta <br>
						<input type="radio" name="xmodalidad" id="mod_otr"> Otros
					</td>
					<td width="200px">
						<input type="radio" name="xmodalidad" id="mod_tra"> Traslados <br>
						<input type="radio" name="xmodalidad" id="mod_tod"> Todos 
					</td>		
				</tr>
			</table>
	  	</div>
