	...
	<div class="row">
			...
			<table>
				...
				<tr>
					...
					<td><select id="cbxReporte1" style="width: 350px;">
						...
						<?php echo listaparametros($_SESSION['ideusuario'],'I'); ?>
	  ...
	  <div class="col-md-6" style="width: 620px; ">
	  	<div class="seccion">
	  		...
	  		<h2 align="center">Importaciones </h2>
	  	</div>
		<br>
