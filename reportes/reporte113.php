<?php
    ...
    $titulo = "INFORME FINANCIERO CABOT";
    $file="informefinancierocabot";
    $registros="";
    $param_fecha="";
    ...
    // 
    $sql = "SELECT ED.NUMERO_PEDIDO, SAU.NUMERO_DEX, SAU.FECHA_DEX,
        DT.NUMERO_DOCUMENTO_TRANSPORTE , DT.FECHA_DOCUMENTO_TRANSPORTE, LEFT(TRIM(ED.DESCRIPCION),2500) PRODUCTO, ' ' VACIO 
        FROM ESTADOS_DO ED
