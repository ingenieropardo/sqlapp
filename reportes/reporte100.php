<?php
    ...
    $param_fecha="";
    $titulo = "DIM - Detalles Alimentos Polar";
    ...
    $sql  = "SELECT  DATE_FORMAT(FD.FECHA_ACEPTACION, '%M') MES, ED.NUMERO_PEDIDO, A.NOMBRE_ADMINISTRACION, 
                     EX.NOMBRE_EXPORTADOR, SC.NOMBRE_SEGMENTO, FD.NUMERO_STICKER, FD.FECHA_PAGO, 
                     FD.TOTAL_ARANCEL, FD.TOTAL_IVA, FD.TOTAL_LIQUIDADO 
    ...
    switch ($tipo) {            
        case 'XLS':
            ...
            header("Content-Disposition: attachment; filename=detallesapc.xls");
        ...
        case 'HTML':
            ...
            <head>
                ...
                <title>DETALLES OPERACIONES ALIMENTOS POLAR</title>
        ...
        case 'TXT':
            ...
            header('Content-Disposition: inline; filename=detallesapc.txt'); 
        ...
        case 'PDF':
            ...
            $pdf->Cell(15); $pdf->Cell(0,0,'DETALLES ALIMENTOS POLAR',0,1,'');
            $pdf->Ln(0);
