<?php
    ...
    $sql  = "SELECT ED.NUMERO_PEDIDO 'NUMEROvPEDIDO', ED.NUMERO_DO 'NUMERO DO', DT.NUMERO_DOC_TRANS 'NUMERO DOC TRANS', DT.FECHA_DOC_TRANS 'FECHA DOC TRANS', A.SIGLA 'SIGLA', FD.NUMERO_ACEPTACION 'NUMERO ACEPTACION', FD.FECHA_ACEPTACION 'FECHA ACEPTACION', FD.NUMERO_STICKER 'NUMERO STICKER', FD.FECHA_PAGO 'FECHA PAGO', FD.NUMERO_LEVANTE 'NUMERO LEVANTE', FD.FECHA_LEVANTE 'FECHA LEVANTE', FD.PORCENTAJE_IVA 'PORCENTAJE IVA', FD.BASE_IVA 'BASE IVA', FD.TOTAL_IVA 'TOTAL IVA', FD.VALOR_TOTAL_FOB 'VALOR TOTAL FOB', FD.VALOR_FLETES 'VALOR FLETES', FD.VALOR_SEGUROS 'VALOR SEGUROS', FD.VALOR_ADUANA 'VALOR ADUANA', CF.NUMERO_FACTURA 'NUMERO FACTURA', CF.CODIGO_CONDICION_ENTREGA 'CODIGO CONDICION ENTREGA', FD.VALOR_TOTAL_ITEMS 'VALOR TOTAL ITEMS', SUM(DF.TOTAL_ITEM)
