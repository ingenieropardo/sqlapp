<?php
    ...
    // Titulo del reporte
    $titulo="REPORTE DIARIOO UAP DAIMLER";
    
    // Nombre del archivo 
    $archivo="Reporte_Diario_Uap_Daimler";
    ...
    $dimensionCol = array (26.14,  21.14,  21.14,  21.14,  21.14,  20.43,  19.14,  19.14,  19.14,  44.14,  19.14,  19.14,  19.14,  19.14);
    ...
    $sql  = "SELECT COUNT(FD.ID_FORMULARIO_DI) 'N DECLARACIONES', 
        ...
        SUM(FD.TOTAL_ARANCEL) 'GRAVAMEN', 
        SUM(FD.TOTAL_IVA) 'IVA', 
        SUM(FD.TOTAL_LIQUIDADO) 'TRIBUTOS', 
        'AGENCIA DE ADUANAS HUBEMAR SAS NIVEL 1', 
        SUM(FD.VALOR_TOTAL_FOB) 'TOTAL FOB', 
        SUM(FD.VALOR_FLETES) 'FLETES',  
        SUM(FD.VALOR_SEGUROS) 'SEGUROS', 
        SUM(FD.VALOR_OTROS_GASTOS) 'OTROS'

        FROM FORMULARIOS_DIS   FD

        INNER JOIN CABEZA_FACTURAS        CF     ON FD.ID_CABEZA_FACTURA=CF.ID_CABEZA_FACTURA
        INNER JOIN IMPORTACIONES          IM     ON IM.NUMERO_DO=CF.NUMERO_DO
