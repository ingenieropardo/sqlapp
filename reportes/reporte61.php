<?php
    ...
    $sql  = "SELECT NUMERO_DO, TIPO_PROCESO, date_format(FECHA_INICIO,'%d/%m/%Y %H:%i') FECHA, U.NOMBRE_PERSONA
        FROM proceso_siglo_xxi PS
        INNER JOIN USUARIOS U ON U.LOGIN=PS.USUARIO_CREACION
        WHERE ESTADO=2
