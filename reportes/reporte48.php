<?php
    ...
    // 
    $sql = "SELECT I.NOMBRE_IMPORTADOR, ED.NUMERO_DO, E.NOMBRE_PERSONA EJECUTIVO, ED.TIPO_REGIMEN, DATE_FORMAT(ED.FECHA_APERTURA, '%Y') APERTURA_ANO,

        IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='01','ENERO',IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='02','FEBRERO', IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='03','MARZO',
        IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='04','ABRIL', IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='05','MAYO',IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='06','JUNIO',
        IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='08','AGOSTO', IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='09','SEPTIEMBRE',IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='10','OCTUBRE',
        IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='07','JULIO', IF(DATE_FORMAT(ED.FECHA_APERTURA, '%m')='11','NOVIEMBRE', 'DICIEMBRE'))))))))))) APERTURA_MES,  ED.NUMERO_FACTURA, ED.FECHA_FACTURA, ED.CODIGO_SUCURSAL_OP, IM.FECHA_DOCS_OK, IM.FECHA_LEVANTE, IM.FECHA_LLEGADA_MCIA, IM.FECHA_RETIRO_TOTAL, ED.TRM, COALESCE( DT.NUMERO_DOC_TRANS, DTE.NUMERO_DOCUMENTO_TRANSPORTE, DF.NUMERO_DOCUMENTO_TRANSPORTE)
        FROM ESTADOS_DO ED
