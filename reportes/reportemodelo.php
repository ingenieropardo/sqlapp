<?php
    ...
    $param_fecha="";
    // Titulo del reporte
    $titulo="INDICADOR DE EXPORTACIONES";
    // Nombre del archivo 
    ...
    $dimensionCol = array (14.57,  17,  37.71,  16.86,  17,  35.43,  52.29,  27.57,  17,  21.57,  17,  17,  13.86,  27.57,  16.43,  16.43,  14.57,  13.86,  13.86,  24.71,  13.86,  13.86,  13.86,  13.86,  27.57,  21.29,  21.29,  21.29,  17,  21.29,  21.29,  21.29,  17,  17,  21.29,  21.29,  21.29,  17,  27,  22.71,  13.29,  13.29,  13.29,  13.29,  17,  13.71, 17,  20.43,  20.43,  20.43,  20.43,  13.57,  13.57,  17.14,  17,  17, 17,  17,  17,  47.86);


    $tipodato= array('T','T','T','T','T','T','T','T','D','T','D','D','D','T','D','D','D','D','D','T','D','D','D','E','T','E','T','T','D','T','T','T','D','E','T','T','T','N','T','E','E','E','E','E','E','N','T','T','T','T','T','D','T','D','T','E','T','T','D','T');
