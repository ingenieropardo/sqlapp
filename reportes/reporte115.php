<?php
    ...
    $param_fecha="";
    // Titulo del reporte
    $titulo="TERMINOS DE PERMANENCIA";
    // Nombre del archivo 
    $archivo="Terminos_permanencia";
    $registros = "";
    ...
    $dimensionCol = array (41, 12, 12.71, 21.57, 45.14, 54.71, 21.57, 32.14, 15.29, 13.29, 13.29, 12, 12, 12.71, 10.71, 10.71, 30.71);


    $tipodato= array('T','T','T','T','T','T','T','T','D','D','D','D','D','N','N','T');
    ...
    $sql  = "SELECT IM.NOMBRE_IMPORTADOR 'CLIENTE', 
        ED.NUMERO_DO 'NUMERO DO', 
        ED.NUMERO_PEDIDO 'PEDIDO', 
        UC.NUMERO_ID_CONTENEDOR 'CONTENEDOR', 
        ...
        VM.FECHA_ETA 'FECHA ETD',

        CASE DATE_FORMAT(UC.FECHA_INGRESO_PUERTO, '%m') WHEN '01' Then 'Enero'  WHEN '02' Then 'Febrero'
            ...
            WHEN '10' Then 'Octubre' WHEN '11' Then 'Noviembre' WHEN '12' Then 'Diciembre' END AS 'MES INGRESO',

        UC.FECHA_INGRESO_PUERTO 'FECHA INGRESO',

        CASE DATE_FORMAT(VM.FECHA_ETS, '%m') WHEN '01' Then 'Enero'  WHEN '02' Then 'Febrero'
            WHEN '03' Then 'Marzo' WHEN '04' Then 'Abril' WHEN '05' Then 'Mayo' WHEN '06' Then 'Junio'
            WHEN '07' Then 'Julio' WHEN '08' Then 'Agosto' WHEN '09' Then 'Septiembre'
            WHEN '10' Then 'Octubre' WHEN '11' Then 'Noviembre' WHEN '12' Then 'Diciembre' END AS 'MES EMBARQUE',
    
        VM.FECHA_ETS 'FECHA DE EMBARQUE', 
        DATEDIFF(VM.FECHA_ETS, UC.FECHA_INGRESO_PUERTO)+1 'DIAS BODEGAJE', 
        '7' DIAS_LIBRES_TERMINAL, 
        ((DATEDIFF(VM.FECHA_ETS, UC.FECHA_INGRESO_PUERTO)+1) - 7 ) 'DIAS TERMINAL VS DIAS LIBRES'
    
    FROM ESTADOS_DO ED

    LEFT OUTER JOIN IMPORTADORES                   IM  ON IM.ID_IMPORTADOR=ED.ID_IMPORTADOR
    ...
    LEFT OUTER JOIN EXPORTADORES                   C   ON C.ID_EXPORTADOR =DT.ID_EXPORTADOR_IMPORTADOR
