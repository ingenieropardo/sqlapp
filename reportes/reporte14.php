<?php
    ...
    $titulo = "TRAZABILIDAD IMPO/EXPO";
    $file="trazabilidadimpoexpo";
    $registros="";
    $param_fecha="";
    ...
    // 
    $sql = "SELECT DISTINCT ED.NUMERO_DO, ED.NUMERO_PEDIDO, SC.NOMBRE_SEGMENTO, I.NOMBRE_IMPORTADOR, E.NOMBRE_EXPORTADOR,
        DT.NUMERO_DOC_TRANS , IM.FECHA_LLEGADA_MCIA, IM.FECHA_DOCS_OK, FD.FECHA_ACEPTACION, FD.FECHA_LEVANTE, IM.FECHA_DOCS_TRANSPORTADOR, IM.FECHA_RETIRO_TOTAL, IM.FECHA_MERCANCIA_EN_PLANTA, IM.FECHA_FACTURAS_OK, IM.FECHA_LIQUIDACION,  IM.FECHA_LUZ_VERDE, ED.NUMERO_FACTURA
        FROM ESTADOS_DO ED
