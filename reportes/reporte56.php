<?php
    ...
    $sql  = "SELECT   ED.NUMERO_DO 'NUMERO DO', ED.NUMERO_PEDIDO 'NUMERO PEDIDO', FD.NUMERO_ACEPTACION 'NUMERO ACEPTACION',
      DATE_FORMAT(FD.FECHA_ACEPTACION, '%d/%m/%Y') 'ACEPTACION', FD.NUMERO_LEVANTE 'NUMERO LEVANTE',
      DATE_FORMAT(FD.FECHA_LEVANTE, '%d/%m/%Y') 'FECHA LEVANTE', FD.CODIGO_POSICION 'CODIGO POSICION',
      FD.CODIGO_MODALIDAD 'NUMERO LEVANTE',  CF.NUMERO_FACTURA 'NUMERO FACTURA', P.CODIGO_PRODUCTO 'CODIGO PRODUCTO',
      ...
      FD.TOTAL_ARANCEL 'TOTAL ARANCEL', FD.BASE_IVA 'BASE IVA', FD.TOTAL_IVA 'TOTAL IVA', ED.TRM 'TRM', FD1.VALOR_FOB 'VALOR FOB',
      CF.CODIGO_CONDICION_ENTREGA 'CODIGO CONDICION ENTREGA', FD.VALOR_TOTAL_ITEMS 'VALOR_TOTAL_ITEMS',
      ...
      LEFT OUTER JOIN (SELECT F.NUMERO_DO, SUM(TOTAL_FACTURA_ACTUAL_USD) VALOR_FOB FROM CABEZA_FACTURAS  F  GROUP BY 1 ) FD1
    ON FD1.NUMERO_DO=ED.NUMERO_DO
