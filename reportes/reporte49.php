<?php
    ...
    $param_fecha="";
    // Titulo del reporte
    $titulo="REPORTE UAP VER 4";
    // Nombre del archivo 
    $archivo="reporteUapVer4";
    ...
    $dimensionCol = array (19, 15, 30, 14, 14, 36, 15, 11, 22, 20, 20, 22, 16, 20, 13.29, 15.71, 20, 20, 20, 12, 12, 17.86, 17.86, 12, 23, 23, 15, 15, 15);

    $tipodato = array ("T","T","T","T","T","T","T","N","T","T","D","T","D","T","D","N","N","N","N","N","N","T","N","N","N","N","N","N","T");
    ...
    $sql  = "SELECT ED.NUMERO_PEDIDO 'PEDIDO', 
        ED.NUMERO_DO 'DO', 
        I.NOMBRE_IMPORTADOR 'CLIENTE', 
        D.NUMERO_FACTURA 'FACTURA', 
        P.CODIGO_PRODUCTO 'AGI CODE', 
        DF.NOMBRE_COMERCIAL 'PRODUCTO',  
        DF.CODIGO_UNIDAD_CCIAL_DIAN 'UNIDAD COMERCIAL', 
        FD.CANTIDAD 'CANTIDAD DI', 
        S.NOMBRE_SUCURSAL 'CIUDAD', 
        ...
        (FD.VALOR_TOTAL_FOB*ED.TRM) 'FOB COP', 
        FD.VALOR_ADUANA 'VALOR ADUANA', 
        (FD.VALOR_ADUANA*ED.TRM) 'VALOR ADUANA', 
        ED.TRM 'TRM', 
        ...
        (FD.VALOR_ADUANA/FD.CANTIDAD) 'VALOR UNITARIO ADUANA', 
        DF.VALOR_UNITARIO 'VALOR UNITARIO', 
        D.CODIGO_CONDICION_ENTREGA 'CODIGO CONDICION ENTREGA'
        ...
        INNER JOIN CABEZA_FACTURAS          D     ON D.ID_CABEZA_FACTURA= FD.ID_CABEZA_FACTURA
        ...
        INNER JOIN POSICION_ARANCELARIA     PA    ON PA.CODIGO_POSICION=FD.CODIGO_POSICION
