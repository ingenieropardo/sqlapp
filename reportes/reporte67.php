<?php
    ...
    // Titulo del reporte
    $titulo="INFORME DAIMLER";
    
    // Nombre del archivo 
    $archivo="informe_daimler";
    ...
    $dimensionCol = array (17.86,  23,  20.14,  10.71,  19,  20.43,  20.29,  10.71,  10.71,  10.71,  20.43,  10.71,  15.86,  15.86,  15.86);
    ...
    $sql  = "SELECT CD.PROFIT_CENTER 'NUMERO VIN', 
        LEFT(CD.INFO_ADICIONAL, 30) 'BANCO', 
        FD.NUMERO_STICKER 'NUMERO STICKER', 
        DATE_FORMAT(FD.FECHA_PAGO,'%Y%m%d') 'FECHA PAGO', 
        CD.CENTRO_COSTO_GAMA 'CIUDAD', 
        FD.NUMERO_ACEPTACION 'NUMERO ACEPTACION', 
        DATE_FORMAT(FD.FECHA_ACEPTACION,'%Y%m%d') 'FECHA ACEPTACION', 
        FD.NUMERO_LEVANTE 'NUMERO LEVANTE', 
        DATE_FORMAT(FD.FECHA_LEVANTE,'%Y%m%d') 'FECHA LEVANTE', 
        FD.NUMERO_REG_LICENCIA 'NUMERO REG LICENCIA', 
        DATE_FORMAT(FD.FECHA_REGISTRO_IMPO,'%Y%m%d') 'FECHA APROBACION',
        M.LINEA_PRODUCCION 'LINEA PRODUCCION', 
        T.NOMBRE_TRANSPORTADOR 'NOMBRE TRANSPORTADOR', 
        PS.NOMBRE_PAIS 'NOMBRE PAIS'
