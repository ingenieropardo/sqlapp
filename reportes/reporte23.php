<?php
    ...
    // 
    $sql = "SELECT ED.NUMERO_DO, S.NOMBRE_SUCURSAL, I.NOMBRE_IMPORTADOR, DT.FECHA_DOC_DIAN, DT.FECHA_BUQUE, DT.FECHA_MCIA_PTO,
        DT.FECHA_RETIRO, DF.NUMERO_MANIFIESTO_CARGA, DF.FECHA_MANIFIESTO_CARGO, DF.NUMERO_DOCUMENTO_TRANSPORTE, DF.FECHA_DOCUMENTO_TRANSPORTE,
        DF.VALOR_FOB_MERCANCIA , E.NOMBRE_PERSONA
        FROM estados_do ED
