<?php
    ...
    $dimensionCol = array (40,  17,  37,  15,  15,  36,  15,  25,  25,  50, 50);


    $tipodato= array('T','T','T','N','N','T','T','D','D','T','T');
    ...
    $sql  = "SELECT I.NOMBRE_IMPORTADOR 'CLIENTE',
                    ED.NUMERO_DO 'DO',
                    ED.NUMERO_PEDIDO 'PEDIDO',
                    DT.CANTIDAD_CARGA 'CANTIDAD A EMBARCAR',
                    SUM(CR.CANTIDAD) 'CONTENEDORES',
            ...
            FROM DOCUMENTOS_TRANSPORTES_EXPOS             DT
                    LEFT OUTER JOIN ESTADOS_DO                         ED ON DT.NUMERO_DO=ED.NUMERO_DO
                    LEFT OUTER JOIN EXPORTACIONES                      E  ON DT.NUMERO_DO=E.NUMERO_DO
