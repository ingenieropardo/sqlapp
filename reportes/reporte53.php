<?php
    ...
    // Titulo del reporte
    $titulo="FONDO ROTATIVO";
    
    // Nombre del archivo 
    $archivo="fondo_rotativos";
    ...
    $dimensionCol = array (20.29,  20.29,  20.29,  13.29,  20.29,  20.29,  13.29,  17.29,  17.29,  17.29,  10.71,  13.29,  17.29);
    ...
    $sql  = "SELECT S.NOMBRE_SUCURSAL 'NOMBRE SUCURSAL', 
        ...
        FV.NUMERO_FACTURA_VENTA 'NUMERO FACTURA VENTA', 
        DATE_FORMAT(FV.FECHA_FACTURA_VENTA, '%d-%m-%Y') 'FECHA FACTURA VENTA', 
        FV.TOTAL_ANTICIPOS 'TOTAL ANTICIPOS'
