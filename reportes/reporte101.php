<?php
    ...
    $param_fecha="";
    $titulo = "Operaciones - Control Alimentos Polar";
    ...
    // Operaciones - Control Alimentos Polar
    $sql  = "SELECT NULL, ED.NUMERO_PEDIDO, EX.NOMBRE_EXPORTADOR, SC.NOMBRE_SEGMENTO, CF.NUMERO_FACTURA, 
                    CF.TOTAL_FACTURA_ACTUAL_USD, CF.CODIGO_MONEDA, DT.NUMERO_DOC_TRANS, NULL, 
                    IM.FECHA_DOCS_OK, IM.FECHA_LLEGADA_MCIA, IM.FECHA_MANIFIESTO, IM.FECHA_LEVANTE,
                    NULL, DT.FECHA_DOC_TRANS,IM.FECHA_RETIRO_TOTAL, ED.NUMERO_FACTURA, 
                    IM.FECHA_RECEPCION_FACTURACION
    ...
    switch ($tipo) {            
        case 'XLS':
            ...
            header("Content-Disposition: attachment; filename=controlapc.xls");
        ...
        case 'HTML':
            ...
            <head>
                ...
                <title>CONTROL OPERACIONES ALIMENTOS POLAR</title>
        ...
        case 'TXT':
            ...
            header('Content-Disposition: inline; filename=controlapc.txt'); 
        ...
        case 'PDF':
            ...
            $pdf->Cell(15); $pdf->Cell(0,0,'CONTROL OPERACIONES ALIMENTOS POLAR',0,1,'');
            $pdf->Ln(0);
