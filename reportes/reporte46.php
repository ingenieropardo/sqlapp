<?php
    ...
    $sql  = "SELECT FD.NUMERO_DO 'NUMERO DO', ED.NUMERO_PEDIDO 'NUMERO PEDIDO', DT.NUMERO_DOC_TRANS 'NUMERO DOC TRANS', FD.BULTOS 'BULTOS', E.NOMBRE_EXPORTADOR 'NOMBRE EXPORTADOR', CF.NUMERO_FACTURA 'NUMERO FACTURA', P.CODIGO_PRODUCTO 'CODIGO PRODUCTO', DF.NOMBRE_COMERCIAL 'NOMBRE COMERCIAL', DF.CANTIDAD 'CANTIDAD', DF.TOTAL_ITEM 'TOTAL ITEM', DF.SUM_NETO_PRORRATEO 'SUM NETO PRORRATEO', DF.FLETE_PRORRATEO 'FLETE PRORRATEO', DF.SEGURO_PRORRATEO 'SEGURO PRORRATEO', FD.CODIGO_POSICION 'CODIGO POSICION', DT.NUMERO_MANIFIESTO 'NUMERO MANIFIESTO', DT.FECHA_MANIFIESTO 'FECHA MANIFIESTO'
