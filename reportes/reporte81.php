<?php
    ...
    $sql  = "SELECT ED.NUMERO_DO 'NUMERO DO', ED.NUMERO_PEDIDO 'NUMERO PEDIDO', I.NOMBRE_IMPORTADOR 'NOMBRE IMPORTADOR', DT.FECHA_MANIFIESTO 'FECHA MANIFIESTO', CF.NUMERO_FACTURA 'NUMERO FACTURA', CF.FECHA_FACTURA 'FECHA FACTURA', CF.CODIGO_CONDICION_ENTREGA 'CODIGO CONDICION ENTREGA', EX.NOMBRE_EXPORTADOR 'NOMBRE EXPORTADOR', DT.PESO 'PESO', DT.PESO_BRUTO 'PESO BRUTO', CF.CODIGO_MONEDA 'CODIGO MONEDA', CF.TOTAL_FACTURA 'TOTAL FACTURA', DT.NUMERO_DOC_TRANS 'NUMERO DOC TRANS', DT.FECHA_DOC_TRANS 'FECHA DOC TRANS', DT.SUMADOS_NETO 'FOB', DT.FLETE 'FLETE', DT.SEGURO 'SEGURO', (DT.SUMADOS_NETO + DT.FLETE+DT.SEGURO) 'CIF', DF.FLETE_ISLAND_BASF 'ARANCEL', DF.FLETE_ISLAND_CLIENTE 'IVA', DF.ESCOLTA_BASF 'CIF PESOS'
  ...
  LEFT OUTER JOIN DETALLES_FACTURAS      DF    ON CF.ID_CABEZA_FACTURA=DF.ID_CABEZA_FACTURA
