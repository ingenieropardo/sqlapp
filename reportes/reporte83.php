<?php
    ...
    $sql  = "SELECT ED.NUMERO_PEDIDO 'NUMERO PEDIDO', E.NOMBRE_EXPORTADOR 'NOMBRE EXPORTADOR', CONCAT(CF.CODIGO_CONDICION_ENTREGA,' ',IM.LUGAR_ENTREGA) 'TERMINO DE NEGOCIACIÓN', CF.NUMERO_FACTURA 'NUMERO FACTURA', SC.NOMBRE_SEGMENTO 'NOMBRE SEGMENTO',CF.TOTAL_FACTURA 'TOTAL FACTURA', IF(CF.CODIGO_MONEDA='5', 'FRANCO SUIZO', CF.CODIGO_MONEDA) 'TIPO DE MONEDA'

    FROM CABEZA_FACTURAS    CF

    LEFT OUTER JOIN ESTADOS_DO            ED   ON ED.NUMERO_DO=CF.NUMERO_DO
