<?php
    ...
    $param_fecha="";
    // Titulo del reporte
    $titulo="ESTADO MOTONAVES";
    // Nombre del archivo 
    $archivo="ESTADOMOTONAVES";
    $registros = "";
    ...
    $dimensionCol = array (17,  22,  22,  22,  18,  23,  14,  14,  56,  46,  28,  12,  12,  12,  14,  12,  12,  12);


    $tipodato= array('T','T','T','E','E','T','T','T','T','T','T','D','D','D','E','D','E','D');
    ...
    $sql  = "SELECT ED.NUMERO_DO 'DO',
                    ...
                    UPPER(DP.NOMBRE_DEPOSITO) 'LUGAR DE EMBARQUE',
                    ...
                    DATE_FORMAT(MD.FECHA_ETA, '%d/%m/%Y') 'FECHA ETAD',
                    DATEDIFF(MD.FECHA_ETA, VM.FECHA_ETA )+1 'TIEMPO ESTIMADO',
                    DATE_FORMAT(MD.FECHA_RTAD, '%d/%m/%Y') 'FECHA RTAD',
                    DATEDIFF(MD.FECHA_RTAD, VM.FECHA_ETS )+1 'TIEMPO TRANSITO',
                    DATE_FORMAT(EX.FECHA_ZARPE, '%d/%m/%Y') 'FECHA DE ZARPE'
