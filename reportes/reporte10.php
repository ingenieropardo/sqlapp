<?php
    ...
    $titulo = "REPORTE DE ARCHIVO";
    $file="reportedearchivo";
    $registros="";
    $param_fecha="";
    ...
    // 
    $sql = "SELECT ED.NUMERO_DO, ED.NUMERO_PEDIDO, I.NOMBRE_IMPORTADOR, EM.NOMBRE_PERSONA, IM.FECHA_LEVANTE, A.FECHA_ENVIADO_ARCHIVAR,  A.FECHA_INGRESO_ARCHIVO, A.FECHA_ENVIADO_ARCHIVAR_ING,  A.UBICACION,  A.FECHA_PRESTAMO, A.USUARIO_PRESTADOR
        FROM ESTADOS_DO ED
        LEFT OUTER JOIN IMPORTADORES I ON ED.ID_IMPORTADOR=I.ID_IMPORTADOR
        LEFT OUTER JOIN ARCHIVADORES A ON ED.NUMERO_DO=A.NUMERO_DO
