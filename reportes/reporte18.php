<?php
    ...
    $param_fecha="";
    $titulo="DECLARACIONES ESPECIALES";
...
<?php
    ...
    // 
    $sql = "SELECT ED.NUMERO_DO, YEAR(FD.FECHA_ACEPTACION) ANIO , FD.NUMERO_ACEPTACION, FD.VALOR_TOTAL_FOB, 
        FD.VALOR_FLETES,   FV.NUMERO_DECLARACION_DAV, ( FD.VALOR_TOTAL_FOB + FD.VALOR_FLETES) VALOR_CFR, 
        CF.NUMERO_FACTURA,  NULL DIFERENCIA,  DT.NUMERO_DOC_TRANS , DT.FECHA_DOC_TRANS
        ...
        LEFT OUTER JOIN FORMULARIOS_DVA FV ON CF.ID_CABEZA_FACTURA=FV.ID_CABEZA_FACTURA
