<?php
    ...
    $param_fecha="";
    $titulo="REGISTRO DE IMPORTACIÓN";
    $registros = "";
    ...
    if($numerodo=="" && $numeroped=="" && $ordencompra=="" && $doctrans=="" ){
        ...
        if($flevantei<>"")    $param_fecha .="AND (ED.FECHA_APERTURA      >= '$flevantei 00:00:00'   AND  ED.FECHA_APERTURA     <= '$flevantef 23:59:59') ";
    ...
    $sql  = "SELECT ED.NUMERO_DO 'NUMERO DO', I.NOMBRE_IMPORTADOR 'NOMBRE IMPORTADOR', ED.CODIGO_SUCURSAL_OP 'CODIGO SUCURSAL OP', RI.PUERTO_EMBARQUE 'PUERTO EMBARQUE', RI.TOTAL_USD 'TOTAL USD', E.NOMBRE_PERSONA 'NOMBRE PERSONA', RI.FECHA_CREACION 'FECHA CREACION'

      FROM Registros_importacion RI

      LEFT OUTER JOIN ESTADOS_DO       ED     ON ED.NUMERO_DO=RI.NUMERO_DO
