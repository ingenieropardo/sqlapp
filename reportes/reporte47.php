<?php
    ...
    $dimensionCol = array (21.86,  17.57,  14.29,  19.71,  19.71,  19.71,  19.71,  14.29,  16.86,  16.86,  16.86,  16.86,  16.86,  16.86,  16.86,  16.86,  16.86,  16.86);

    $tipodato = array ('T','T','D','T','T','T','T','D','N','N','N','N','N','N','N','N','N','N');
    ...
    $sql  = "SELECT CF.NUMERO_FACTURA  'FACTURA', 
                    DT.NUMERO_DOC_TRANS 'DOC TRANSPORTE', 
                    DATE_FORMAT(DT.FECHA_DOC_TRANS, '%d/%m/%Y') 'FECHA BL', 
                    FD.CODIGO_POSICION 'SUBPARTIDA',
                    ED.NUMERO_PEDIDO 'LOTE',  
                    FD.NUMERO_ACEPTACION  'NO. ACEPTACION', 
                    FD.NUMERO_STICKER 'NO. STICKER',  
                    DATE_FORMAT(FD.FECHA_PAGO, '%d/%m/%Y') 'FECHA STICKER',
                    FD.VALOR_TOTAL_FOB 'VALOR FOB USD', 
                    FD.VALOR_FLETES 'FLETES', 
                    FD.VALOR_SEGUROS 'SEGURO', 
                    FD.AJUSTE_VALOR  'AJUSTE', 
                    ED.TRM 'TRM', 
                    FD.BASE_IVA 'BASE IVA',
                    FD.BASE_ARANCEL 'BASE ARANCEL', 
                    FD.TOTAL_IVA 'TOTAL IVA', 
                    FD.TOTAL_ARANCEL 'TOTAL ARANCEL', 
                    FD.TOTAL_LIQUIDADO 'TOTAL IMPUESTOS'
