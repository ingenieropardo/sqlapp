<?php
    ...
    // Titulo del reporte
    $titulo="REPORTE_EUAP611";
    
    // Nombre del archivo 
    $archivo="REPORTE_EUAP611";
    ...
    $dimensionCol = array (15,  15.71,  23.57,  25.43,  18.71,  28.14,  16.71,  16.71,  16.71,  18.71,  18.71);
    ...
    $sql  = "SELECT CF.NUMERO_FACTURA 'NUMERO FACTURA', 
        ED.NUMERO_PEDIDO 'NUMERO PEDIDO',
        ED.NUMERO_DOCUMENTO_TRANSPORTE 'NUMERO DOCUMENTO TRANSPORTE', 
