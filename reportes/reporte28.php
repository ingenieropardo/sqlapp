<?php
    ...
    // Titulo del reporte
    $titulo="REPORTE DECLARACIONES DE IMPORTACIÓN";
    ...
    $dimensionCol = array (13.86,  19.29,  45.14,  19.43,  19.43,  19.43,  19.43,  19.43,  19.43,  19.43,  19.43,  16.14,  16.14,  16.14,  16.14,  16.14,  8.29,  11.57,  10.71,  13.86,  13.86,  13.86);
    ...
    $sql  = "SELECT ED.NUMERO_DO 'NÚMERO DO', 
        ...
        DT.FECHA_DOC_TRANS 'FECHA DOC TRANS',
        ...
        FD.FECHA_ACEPTACION 'FECHA ACEPTACION', 
      ...
      LEFT OUTER JOIN IMPORTACIONES            IM    ON FD.NUMERO_DO=IM.NUMERO_DO
