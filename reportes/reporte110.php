<?php
    ...
    $param_fecha="";
    $titulo="REPORTE EMPADRONAMIENTO";
    ...
    $sql  = "SELECT FD.NUMERO_ACEPTACION 'NUMERO ACEPTACION', FD.FECHA_ACEPTACION 'FECHA ACEPTACION', DF.MARCA_COMERCIAL 'MARCA COMERCIAL', DF.TIPO 'TIPO', NULL COMBUSTIBLE, NULL CILINDRAJE, NULL 'CODIGO MOTOR', NULL CHASIS, NULL MOTOR, DF.CLASE 'CLASE', NULL LINEA, DF.MODELO 'MODELO', NULL PUERTAS, NULL COLOR, FD.NUMERO_LEVANTE 'NUMERO LEVANTE', FD.FECHA_LEVANTE 'FECHA LEVANTE', A.NOMBRE_ADMINISTRACION 'NOMBRE ADMINISTRACION', ED.NUMERO_DO 'NUMERO DO', ED.NUMERO_PEDIDO 'NUMERO PEDIDO', TRIM(LEFT(
      DF.DESCRIPCION, 4700))'DESCRIPCIÓN'
