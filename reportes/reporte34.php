...
$estiloTituloColumnas= array(
  ...
  'color' => array(
    ...
    $dimensionCol = array (16,  16,  16,  16,  55.14,  16,  16,  16,  15.14);
    ...
    $sql  = "SELECT 
                    ED.NUMERO_ORDEN_COMPRA 'OC', 
                    CF.NUMERO_FACTURA 'No FACTURA', 
                    CAST(FD.VALOR_TOTAL_FOB AS  DECIMAL(12,2)) 'FOB', 
                    CAST(FD.VALOR_FLETES AS  DECIMAL(12,2)) 'FLETES', 
                    E.NOMBRE_EXPORTADOR 'NOMBRE EXPORTADOR', 
                    FD.NUMERO_ACEPTACION 'NUMERO ACEPTACION DECLARACION',
                    DATE_FORMAT(FD.FECHA_ACEPTACION, '%d/%m/%Y') 'FECHA DECLARACION', 
                    DT.NUMERO_DOC_TRANS 'DOCUMENTO DE TRANSPORTE', 
                    DATE_FORMAT(DT.FECHA_DOC_TRANS, '%d/%m/%Y')  'FECHA DOCUMENTO'
            ...
            FROM FORMULARIOS_DIS FD
                   ...
                   INNER JOIN EXPORTADORES            E    ON E.ID_EXPORTADOR=CF.ID_EXPORTADOR
                   INNER JOIN DOCUMENTOS_TRASPORTE    DT   ON DT.NUMERO_DO=FD.NUMERO_DO
