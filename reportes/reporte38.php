<?php
    ...
    $param_fecha="";
    // Titulo del reporte
    $titulo="KPI TRANSLADOS";
    // Nombre del archivo 
    $archivo="kpi_translados";
    ...
    if($numerodo=="" && $numeroped=="" && $ordencompra=="" && $doctrans=="" ){
        ...
        $filtros = " WHERE ED.ANULADO='N' AND ED.TIPO_REGIMEN='T'";
    ...
    $sql  = "SELECT DATE_FORMAT(FD.FECHA_ACEPTACION, '%Y') 'AÑO', 
        DATE_FORMAT(FD.FECHA_ACEPTACION, '%m') 'MES', 
        FD.FECHA_ACEPTACION 'FECHA DE PRESENTACION', 
        ED.NUMERO_DO 'DO AGENTE DE ADUANA', 
        ED.NUMERO_PEDIDO 'PEDIDO', 
        A.NOMBRE_ADMINISTRACION 'ADUANA', 
        CF.NUMERO_FACTURA 'FACTURA',
        CF.FECHA_FACTURA 'FECHA DE FACTURA', 
        CF.CODIGO_CONDICION_ENTREGA 'INCOTERM', 
        EX.NOMBRE_EXPORTADOR 'PROVEEDOR', 
        FD.PESO_NETO 'PESO NETO', 
        FD.PESO_BRUTO 'PESO BRUTO', 
        FD.VALOR_TOTAL_FOB 'FOB US$ DOLARES TOTAL FACTURA', 
        FD.VALOR_ADUANA 'VALOR CIF', 
        ED.TRM 'TRM', 
        DT.NUMERO_DOC_TRANS 'DOCUMENTO DE TRANSPORTE', 
        FD.NUMERO_STICKER 'NUMERO STICKER', 
        FD.FECHA_PAGO 'FECHA DE PAGO', 
        TD.NOMBRE_TIPO_DECLARACION 'TIPO DE DECLARACION', 
        FD.VALOR_TOTAL_FOB 'VALOR FOB US$', 
        FD.VALOR_FLETES 'FLETE$ US', 
        FD.VALOR_SEGUROS 'SEGURO US$', 
        FD.VALOR_OTROS_GASTOS 'OTROS GASTOS US$', 
        FD.AJUSTE_VALOR 'AJUSTE US$', 
        FD.VALOR_ADUANA 'VALOR ADUANA US$', 
        FD.PORCENTAJE_ARANCEL '% ARANCEL', 
        FD.BASE_ARANCEL 'BASE ARANCEL COP', 
        FD.TOTAL_ARANCEL 'ARANCEL COP', 
        FD.PORCENTAJE_IVA '% IVA', 
        FD.BASE_IVA 'BASE IVA COP', 
        FD.TOTAL_IVA 'IVA COP', 
        FD.TOTAL_LIQUIDADO 'TOTAL TRIBUTOS COP', 
        FD.NUMERO_LEVANTE 'NUMERO DE LEVANTE', 
        FD.FECHA_LEVANTE 'FECHA DE LEVANTE', 
        FD.NUMERO_ACEPTACION 'NUMERO ACEPTACION', 
        FD.FORMULARIO_FISICO 'FORMULARIO FISICO', 
        FD.FECHA_ACEPTACION 'FECHA ACEPTACIÓN', 
        FD.CODIGO_MODALIDAD 'MODALIDAD', 
        FD.CODIGO_POSICION 'SUBPARTIDA', 
        FD.CANTIDAD 'CANTIDAD', 
        FD.CIP 'CIP', 
        PA.NOMBRE_PAIS 'NOMBRE PAIS DE PROCEDENCIA', 
        PA1.NOMBRE_PAIS 'NOMBRE PAIS DE ORIGEN', 
        LEFT(TRIM(FD.DESCRIPCION), 4700) 'DESCRIPCIÓN'
...
<?php
    ...
    // Dim - Reporte de Tributos por DIM
    $sql  = "SELECT ED.NUMERO_DO  'NUMERO DO', ED.NUMERO_PEDIDO 'NUMERO PEDIDO', LEFT(TRIM(ED.DESCRIPCION),250) 'PRODUCTO',
