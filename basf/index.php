<!DOCTYPE html>
<style>
  #datos table tr:hover { background: #CCF4FF; }
    .buscar {
      border-radius: 15px;
      width: 35px;
      background: #E9CE4F;
...
<?php
  ...
  if(isset($_POST['conecta'])) {
      ...
      $sql = "select * from usuarios where usuario='$usuario' and clave='$clave' and estado='A'";
      ...
      if($reg = @mysql_fetch_array($res)) {
          ...
          $_SESSION['rol']           = "$reg[2]";
          $_SESSION['nomusuario']    = "$reg[4]";
          $_SESSION['ideusuario']    = "$reg[0]";
          $_SESSION['cargo']         = "$reg[3]";
...
?>
    <head>
        ...
        <title>BASF CLIENTE 1.0</title>
        <meta name="description" content="Software de Consulta BASF App :. 2019">
        ...
        <link rel="icon" type="image/jpg" href="img/favico.png" />         
    ...
    <body style="font-family: Arial; " onload="setInterval("reload()",2000);">
        ...
        <header class="site-header push" style="background:   #004B83; padding: 5px; text-align: left; margin: 0px; margin-left: -20px; width: 110%;">
            ...
            <button class="menu-btn" style="background:   #004B83; padding: 0px; margin: 0px; font-size: 20px; width: 40px;">
              <span class="glyphicon glyphicon-th"></span> </button> 
                <font color="#E9CE4F" size="4">BASF</font>
                <font color="white">CLIENTE HUBEMAR</font>
                <font color="white" size="4"></b><font color="#E9CE4F" size="2">1.0</font> 
                <font size="2" color="#F1EFCD" class="vistapc">
                    <?php  
                          if(isset($_SESSION['nomusuario']))
                            echo utf8_decode(strtoupper($_SESSION['nomusuario']." | ".$_SESSION['cargo'])); 
                    ?>
                </font>
        ...
        <nav class="pushy pushy-left" data-focus="#first-link" >
            ...
            <?php
                ...
                switch ($rol) {
                  ...
                  case "OPERATIVO1":  $menu = "vistas/menurol2.php";  break;
                  case "EJECUTIVO1":  $menu = "vistas/menurol3.php";  break;
        ...
        <div id="container"  style="margin-top: -60px;  margin-bottom: 0px; margin-right: -40px">
            <?php 
              ...
              if(isset($_GET['accion'])) {
                ...
                switch ($accion) {
                      ...
                      case "ingresospropios" :  $archivo = "vistas/ingresospropios.php";  break;
                      case "bitacora"        :  $archivo = "vistas/bitacora.php";         break;
                      case "usuarios"        :  $archivo = "vistas/usuarios.php";         break;
                      case "cambiopwd"       :  $archivo = "vistas/clave.php";            break;
                      case "savingac"        :  $archivo = "vistas/saving_ac.php";        break;
                      case "uap"             :  $archivo = "vistas/uap.php";              break;
                      case "flete"           :  $archivo = "vistas/flete.php";            break;
                      case "infouap"         :  $archivo = "vistas/infouap.php";          break;
                      case "kpitiempos"      :  $archivo = "vistas/kpitiempos.php";       break;
                      case "retenciones"     :  $archivo = "vistas/retenciones.php";      break;
                      case "gastosterceros"  :  $archivo = "vistas/gastosterceros.php";   break;
                      case "icompensaciones" :  $archivo = "vistas/icompensaciones.php";  break;
                      case "ecompensaciones" :  $archivo = "vistas/ecompensaciones.php";  break;
                      case "drop"            :  $archivo = "vistas/drop.php";             break;
                      case "otros"           :  $archivo = "vistas/otrosinformes.php";    break;
        ...
        <footer class="site-footer push">
          www.hubemar.com - Agencia de Aduana Nivel 1 - Derechos Reservados 2019 &reg;
...
<script>
    ...
    function resolucion() {
      $("#datos").css("height",window.screen.height-320)
    }
