	  ...
	  <div class="col-md-4" style="width: 560px">
	  	<div class="seccion">
			...
			<table>
				...
				<tr>
					<td>Importador</td>			
					<td><select id="cbxImportador1" style="width: 350px;">
							<option value="-1">Seleccione...</option>
							<option value="0" selected>TODOS</option>
							<?php echo listar(0,3,"select * from importadores order by nombre_importador"); ?>
						</select>
					<button type="button" id="btbuscarimp" class="buscar" data-toggle="modal" data-target="#buscaimp"><span class="fa fa-search"></span></button>
					<script>
				...
				<tr>
					<td>Tercero</td>			
					<td><select id="cbxTercero1" style="width: 350px;">
							<option value="0">TODOS</option>
							<?php echo listar(0,4,"select * from terceros"); ?>
						</select>
						<button class="buscar"><span class="fa fa-search"></span></button>
					</td>
				</tr>
				<tr>
					<td>Ejecutivo</td>			
				...
				<tr>
					...
					<td><select id="cbxReporte1" style="width: 350px;">
						<?php echo listaparametros($_SESSION['ideusuario']); ?>
						<option value="-1">Seleccione...</option>
					</select>
	  	...
	  	<div class="seccion">
			...
			<table>
				...
				<tr>
					<td>Número de Aceptación</td>			
					<td><input type="text" id="txtAceptacion"></td>
				</tr>
			</table>
	  	</div>
	  </div>
