<?php
    ...
    header("Content-Disposition: attachment; filename=ComisionesImportacion$anio.xls");
	...
	if($tipo=="xls") {
        ...
        $titulo = "COMISIONES IMPORTACION - $anio";
		...
		$data->read("../archivos/compensaciones_impo$anio.xls");
